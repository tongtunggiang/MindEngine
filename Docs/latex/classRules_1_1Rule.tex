...
\item[\hyperlink{todo__todo000002}{Todo}]Examine the performance and reusability of using a method. If it is hard to expand, find a way to use a struct/class instead. \end{DoxyRefDesc}
